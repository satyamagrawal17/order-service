...
type OrderServiceClient interface {
	...
	UpdateOrderStatus(ctx context.Context, in *UpdateOrderRequest, opts ...grpc.CallOption) (*OrderResponse, error)
	GetOrdersByUserId(ctx context.Context, in *GetOrderByUserIdRequest, opts ...grpc.CallOption) (*MultipleOrderResponse, error)
}
...
func (c *orderServiceClient) UpdateOrderStatus(ctx context.Context, in *UpdateOrderRequest, opts ...grpc.CallOption) (*OrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(OrderResponse)
...
func (c *orderServiceClient) GetOrdersByUserId(ctx context.Context, in *GetOrderByUserIdRequest, opts ...grpc.CallOption) (*MultipleOrderResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MultipleOrderResponse)
...
type OrderServiceServer interface {
	...
	UpdateOrderStatus(context.Context, *UpdateOrderRequest) (*OrderResponse, error)
	GetOrdersByUserId(context.Context, *GetOrderByUserIdRequest) (*MultipleOrderResponse, error)
...
func (UnimplementedOrderServiceServer) UpdateOrderStatus(context.Context, *UpdateOrderRequest) (*OrderResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrderStatus not implemented")
}
func (UnimplementedOrderServiceServer) GetOrdersByUserId(context.Context, *GetOrderByUserIdRequest) (*MultipleOrderResponse, error) {
...
func _OrderService_GetOrdersByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrdersByUserId(ctx, req.(*GetOrderByUserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
